    ...
    */
        ...
        CeterisParibusPlot.prototype.resizeFonts = function(){
            ...
            if(!this.is_set_font_size_plot_title_){
                ...
                if(!this.init_size_calculations_){this.userDiv_.selectAll('.titleDivCP').style('font', 'bold ' + this.font_size_plot_title_+ 'px sans-serif')}
            }
            ...
            if(!this.is_set_font_size_tootlips_){
                ...
                if(!this.init_size_calculations_){this.plotDivCP_.select('.tooltip').style('font', this.font_size_tootlips_ + 'px sans-serif')};
            }
            ...
            if(!this.is_set_font_size_table_ & this.add_table_){
                ...
                if(!this.init_size_calculations_){this.tableDivCP_.style('font', this.font_size_table_ + 'px sans-serif')};
            }
    ...
    return {
      ...
      resize: function(width, height) {
        ...
        instance.resizePlot_(width, height);
